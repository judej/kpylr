...
class TestBinaryExpressionSyntax:
    def test_kind(self, binary_expression_syntax_simple: BinaryExpressionSyntax) -> None:
        assert binary_expression_syntax_simple.kind() == SyntaxKind.binaryexpression

    def test_getChildren(self, binary_expression_syntax_simple: BinaryExpressionSyntax) -> None:
    ...
    def test_getLastChild(self, binary_expression_syntax_simple: BinaryExpressionSyntax) -> None:
        assert binary_expression_syntax_simple.get_last_child().kind() == SyntaxKind.numbertoken
